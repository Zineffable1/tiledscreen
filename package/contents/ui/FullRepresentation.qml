        ...
        ColumnLayout{
            ...
            ColumnLayout {
                ...
                Category{
                    ...
                    titleVisible: plasmoid.configuration.showPageLabels
                    actionVisible: plasmoid.configuration.showAllAppsButton
                    searchBarAlwaysVisible: plasmoid.configuration.showSearchBar
