...
KCM.SimpleKCM {
    ...
    property alias cfg_showDesktopButton: showDesktop.checked
    property alias cfg_showAllAppsButton: showAllApps.checked
    property alias cfg_showPageLabels: showPageLabels.checked
    property alias cfg_showDateTime: showDateTime.checked
    property alias cfg_showSearchBar: showSearchBar.checked
    ...
    FormCard.FormCardPage {
        ...
        FormCard.FormCard {
            ...
            FormCard.FormSwitchDelegate {
                id: showDesktop
                text: i18n("Show desktop button")
            }
            FormCard.FormSwitchDelegate {
                id: showAllApps
                text: i18n("Show all apps button")
            }
            FormCard.FormSwitchDelegate {
                id: showPageLabels
                text: i18n("Show page labels (Favourites/All Apps/Search)")
            }
            FormCard.FormSwitchDelegate {
                id: showDateTime
                text: i18n("Show date and time")
            }
            FormCard.FormSwitchDelegate {
                id: showSearchBar
